...
This SIP is activated if 5 contracts are deployed that use the same trait that follows this specification and the transfer method in this trait contains the same error type of the response type as the transfer method of the trait of fungible tokens (SIP 10). This must happen before Bitcoin tip #700,000.
